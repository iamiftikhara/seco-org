...
export default function Hero() {
  ...
  const getIcon = (iconName: string) => {
    return iconName === 'newspaper' ? 
      <FaNewspaper className={currentLanguage === 'en' ? 'mr-3' : 'ml-3'} /> : 
      <FaBullhorn className={currentLanguage === 'en' ? 'mr-3' : 'ml-3'} />;
  };

  return (
    <div className="relative min-h-screen flex flex-col">
      <div className="h-[calc(100vh-9.7rem)] relative">
        <Swiper
                ...
                .map((announcement, index) => (
                  <span 
                    ...
                    style={{ color: theme.colors.secondary,
                      fontFamily: announcement.language === "ur"? theme.fonts.ur.primary : theme.fonts.en.primary
                     }}

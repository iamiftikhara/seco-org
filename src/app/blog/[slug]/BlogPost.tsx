...
export default function BlogPost({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const structuredData = post ? {
    ...
    "headline": post.socialShare.title.text,
    "description": post.socialShare.description.text,
    "image": post.image,
    ...
    "articleBody": post.content
      ...
      .map(section => section.text?.content.text)
      .join(" "),
    "inLanguage": post.title.language === "ur" ? "ur" : "en",

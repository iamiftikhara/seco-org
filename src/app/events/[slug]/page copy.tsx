...
export default function EventDetail() {
  ...
  return (
    <>
    <Head>
        <meta property="og:title" content={event.socialShare.title.text} />
        <meta property="og:description" content={event.socialShare.description.text} />
        <meta property="og:url" content={typeof window !== "undefined" ? window.location.href : ""} />
        <meta property="og:type" content={event.socialShare.ogType} />
        <meta property="og:image" content={event.featuredImage} />
        
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={event.socialShare.title.text} />
        <meta name="twitter:description" content={event.socialShare.description.text} />
        <meta name="twitter:site" content={event.socialShare.twitterHandle} />

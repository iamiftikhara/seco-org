  ...
  items: [
    {
      ...
      role: {
        en: "Agricultural Development Officer, Pishin",
        ur: "زرعی ترقیاتی افسر، پشین"
      },
    ...
    },
    {
      ...
      role: {
        en: "UNICEF Education Specialist, Balochistan",
        ur: "یونیسیف تعلیمی ماہر، بلوچستان"
      },
    ...
    },
    {
      ...
      role: {
        en: "Women's Cooperative Leader, Gwadar",
        ur: "خواتین کی تعاونی سوسائٹی کی سربراہ، گوادر"
      },
